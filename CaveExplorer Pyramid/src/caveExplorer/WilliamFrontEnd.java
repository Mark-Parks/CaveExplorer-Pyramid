...
public class WilliamFrontEnd implements MarkSupporter{
	...
	public void reward() {
		System.out.println("As the numbers align, you hear a clicking sound as though mechanisms locked into place.");
		System.out.println("Nothing else seems to happen though. You decided to try swapping two more tiles.");
		String input = CaveExplorer.in.nextLine();
		if(input.length() == 7) {
